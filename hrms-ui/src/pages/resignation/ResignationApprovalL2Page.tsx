      ...
      <div className="flex justify-between items-start mb-6">
        <div>
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-slate-500">Resignation Approval L2</span>
          </div>
        </div>
        <button 
          onClick={() => navigate(-1)}
          ...
          <table className="w-full text-sm text-center text-slate-600 dark:text-slate-300">
            ...
            <tbody className="divide-y divide-border bg-[#f8fafc]">
              {loading ? (
                ...
                <tr><td colSpan={9} className="px-6 py-8 text-slate-500 text-center font-medium">No pending L2 approvals.</td></tr>
              ) : (
                  ...
                  <tr key={row.id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-center gap-2">
                        <button onClick={() => handleUpdateStatus(row.id, 'APPROVED')} className="text-emerald-600 hover:bg-emerald-50 p-1.5 rounded transition-colors" title="Final Approve">
